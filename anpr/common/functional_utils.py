...
def get_filtered_data(form_data, date_time_availability, criteria_order):
    ...
    #print("license_plate_queryset_by_camera_name",len(license_plate_queryset_by_camera_name))
    if criteria_order == "continuous":
        ...
        #print("queryset_further_by_plate_number",len(queryset_further_by_plate_number))
    else:
    ...
    if date_time_availability["status"] == "start_and_end":
        ...
        #print("final_license_plate_query_set", len(final_license_plate_query_set))
