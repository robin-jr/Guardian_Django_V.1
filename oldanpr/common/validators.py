...
def get_status_date_time(start_date_time_str, end_date_time_str):
    ...
    if len(start_date_time_str) > 0 and len(end_date_time_str) > 0:
        ...
        date_time_availability["naive_start_date_time"] = datetime.strptime(start_date_time_str, '%Y-%m-%d %H:%M:%S')
        date_time_availability["naive_end_date_time"] = datetime.strptime(end_date_time_str, '%Y-%m-%d %H:%M:%S')
